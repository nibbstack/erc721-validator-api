export default {
  ...
  TESTS_BASIC: [
    ...
    {id: 4, expected: true, condition: {'3': true}, description: 'Check interface ERC721Metadata.'},
    {id: 5, expected: true, condition: {'3': true}, description: 'Check interface ERC721Enumerable.'},
